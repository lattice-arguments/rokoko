...
/// [`project_one_row_i16_to_u64`] with i32 lane accumulation: exact for
/// packed digits up to 2^15 where the i16 kernel is sized for the chain's
/// base-2^7 scale, at roughly half the throughput.
#[cfg(all(target_arch = "x86_64", target_feature = "avx512f"))]
pub fn project_one_row_i16_to_u64_wide<const DEGREE: usize>(
...
#[cfg(not(all(target_arch = "x86_64", target_feature = "avx512f")))]
pub use project_one_row_i16_to_u64 as project_one_row_i16_to_u64_wide;
