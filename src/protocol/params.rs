...
pub fn cfg_p30<T>(if_p30: T, if_not_p30: T) -> T {
    #[cfg(feature = "p-30")]
    {
        return if_p30;
    }
...
#[inline(always)]
#[allow(unused_variables, unreachable_code)]
pub fn per_config<T>(p26_value: T, p28_value: T, p30_value: T) -> T {
    #[cfg(feature = "p-30")]
    {
        return p30_value;
    }
...
pub fn p_root_aux(nof_openings: usize) -> AuxSumcheckConfig {
    AuxSumcheckConfig {
        ...
        witness_decomposition_base_log: cfg_p30(7, 4),

        next: Some(Box::new(AuxConfig::Sumcheck(P_INT.clone()))),
    }
}
